...
declare global {
  ...
  const usePostsStore: typeof import('../../store/posts')['usePostsStore']
...
declare global {
  ...
  // @ts-ignore
  export type { Post, State } from '../../store/posts'
  import('../../store/posts')
}
...
declare module 'vue' {
  interface ComponentCustomProperties {
    ...
    readonly usePostsStore: UnwrapRef<typeof import('../../store/posts')['usePostsStore']>
